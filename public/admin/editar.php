...
<body>
  ...
  <div class="container mx-auto">
    ...
    <form class="mt-5 mr-96 ml-96" action="" method="POST">
      ...
      <button type="submit" class="focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-400 font-medium rounded-lg text-sm px-4 py-2 mr-2 dark:bg-yellow-400 dark:hover:bg-yellow-500 dark:focus:ring-yellow-600">
        Editar</button>
    </form>
  </div>
