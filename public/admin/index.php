    ...
    <div class="container mx-auto">
        ...
        <div class="overflow-y-auto py-4 px-3">
            <table class="mx-auto text-sm text-left text-gray-500 dark:text-gray-400">
                ...
                <tfoot>
                    <td colspan="3"></td>
                    <td class="ml-8 py-4 px-6 flex"> <a href="insertar.php" class="focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                            Insertar</a>
                    </td>
                </tfoot>
            </table>
