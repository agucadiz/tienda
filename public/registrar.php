...
<body>
    ...
    //Crean las keys login, password y password_repeat.
    ...
    if (isset($login, $password, $password_repeat)) {
        $pdo = conectar();
        //Se debe de crear un array para que no se machaquen los errores, creando asi un array de errores
        //login, password y password_repeat.
        if ($login == '') {
        ...
        if ($vacio) {
            ...
            //Si se ha creado el error login, password o password_repeat crea una variable con el estilo.
            foreach (['login', 'password', 'password_repeat'] as $e) {
                if (isset($error[$e])) {
    ...
    <div class="container mx-auto">
        ...
        <div class="mx-72">
            <form action="" method="POST">
                <div class="mb-6">
                    <!-- Con las variables clases_label y clases_input dan los estilos a los errores. -->
                    ...
                    <!-- Aqui se debe pintar los errores -->
